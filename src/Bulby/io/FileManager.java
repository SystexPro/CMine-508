...
stream.writeString("Purearmor:" + p.purearmor);
stream.writeString("Modarmor:" + p.modarmor);
stream.writeString("SDC:" + p.sdc);
stream.writeString("STR:" + p.str);
stream.writeString("Firecape:" + p.firecape);
stream.writeString("Donecode:" + p.donecode);
stream.writeString("PKP:" + p.pkp);
stream.writeString("GRP:" + p.grp);
stream.writeString("PRP:" + p.prp);
stream.writeString("RTM:" + p.rtm);
...
stream.writeString("Barpoints:" + p.barpoints);
stream.writeString("Bankpintimer:" + p.bankpintimer);
stream.writeString("Deletetimer:" + p.deletetimer);
stream.writeString("BTR:" + p.btr);
stream.writeString("Membertimer:" + p.membertimer);
stream.writeString("MTR:" + p.mtr);
...
stream.writeString("Inpest:" + p.inpest);
        ...
        stream.writeString("GreatWar:" + p.GreatWar);
...
loadscores(p);
		...
		p.ignores.add(ignoreName);
                ...
                } else if (line.startsWith("RTM:")) {
                    p.rtm = Integer.parseInt(line.substring(4));              
                } else if (line.startsWith("PRP:")) {
                    p.prp = Integer.parseInt(line.substring(4));            
                } else if (line.startsWith("GRP:")) {
                    p.grp = Integer.parseInt(line.substring(4));
                } else if (line.startsWith("BTR:")) {
                    p.btr = Integer.parseInt(line.substring(4)); 
                } else if (line.startsWith("Purearmor:")) {
                    p.purearmor = Integer.parseInt(line.substring(10));
                } else if (line.startsWith("Modarmor:")) {
                    p.modarmor = Integer.parseInt(line.substring(9));
                } else if (line.startsWith("Membertimer:")) {
                    p.membertimer = Integer.parseInt(line.substring(12));
                } else if (line.startsWith("Barpoints:")) {
                    p.barpoints = Integer.parseInt(line.substring(10));
                ...
                } else if (line.startsWith("Inpest:")) {
                    p.inpest = Integer.parseInt(line.substring(7));
                } else if (line.startsWith("Bankpintimer:")) {
                    p.bankpintimer = Integer.parseInt(line.substring(13));
                } else if (line.startsWith("Deletetimer:")) {
                    p.deletetimer = Integer.parseInt(line.substring(12));
                } else if (line.startsWith("Pestpoints:")) {
                    p.pestpoints = Integer.parseInt(line.substring(11));
                } else if (line.startsWith("STR:")) {
                    p.str = Integer.parseInt(line.substring(4));    
                ...
                } else if (line.startsWith("GreatWar:")) {
                    p.GreatWar = Integer.parseInt(line.substring(9));
...
loadscores(p);
        ...
        try {
            FileInputStream in = new FileInputStream(
                    "./data/characters/backup/" + p.username + ".dat");
...
if (line.startsWith("place01:")) { place01 = Integer.parseInt(line.substring(8)); }
else if (line.startsWith("place02:")) { place02 = Integer.parseInt(line.substring(8)); }
else if (line.startsWith("place03:")) { place03 = Integer.parseInt(line.substring(8)); }
else if (line.startsWith("place04:")) { place04 = Integer.parseInt(line.substring(8)); }
else if (line.startsWith("place05:")) { place05 = Integer.parseInt(line.substring(8)); }
else if (line.startsWith("place06:")) { place06 = Integer.parseInt(line.substring(8)); }
else if (line.startsWith("place07:")) { place07 = Integer.parseInt(line.substring(8)); }
else if (line.startsWith("place08:")) { place08 = Integer.parseInt(line.substring(8)); }
else if (line.startsWith("place09:")) { place09 = Integer.parseInt(line.substring(8)); }
else if (line.startsWith("place10:")) { place10 = Integer.parseInt(line.substring(8)); }
else if (line.startsWith("place11:")) { place11 = Integer.parseInt(line.substring(8)); }
else if (line.startsWith("place12:")) { place12 = Integer.parseInt(line.substring(8)); }
else if (line.startsWith("place13:")) { place13 = Integer.parseInt(line.substring(8)); }
else if (line.startsWith("place14:")) { place14 = Integer.parseInt(line.substring(8)); }
else if (line.startsWith("place15:")) { place15 = Integer.parseInt(line.substring(8)); }
else if (line.startsWith("place16:")) { place16 = Integer.parseInt(line.substring(8)); }
else if (line.startsWith("place17:")) { place17 = Integer.parseInt(line.substring(8)); }
else if (line.startsWith("place18:")) { place18 = Integer.parseInt(line.substring(8)); }
else if (line.startsWith("place19:")) { place19 = Integer.parseInt(line.substring(8)); }
else if (line.startsWith("place20:")) { place20 = Integer.parseInt(line.substring(8)); }
else if (line.startsWith("place21:")) { place21 = Integer.parseInt(line.substring(8)); }
else if (line.startsWith("place22:")) { place22 = Integer.parseInt(line.substring(8)); }
else if (line.startsWith("place23:")) { place23 = Integer.parseInt(line.substring(8)); }
else if (line.startsWith("place24:")) { place24 = Integer.parseInt(line.substring(8)); }
else if (line.startsWith("place25:")) { place25 = Integer.parseInt(line.substring(8)); }
else if (line.startsWith("place26:")) { place26 = Integer.parseInt(line.substring(8)); }
else if (line.startsWith("place27:")) { place27 = Integer.parseInt(line.substring(8)); }
else if (line.startsWith("place28:")) { place28 = Integer.parseInt(line.substring(8)); }
else if (line.startsWith("place29:")) { place29 = Integer.parseInt(line.substring(8)); }
else if (line.startsWith("place30:")) { place30 = Integer.parseInt(line.substring(8)); }

else if (line.startsWith("placeXP01:")) { placeXP01 = Integer.parseInt(line.substring(10)); }
else if (line.startsWith("placeXP02:")) { placeXP02 = Integer.parseInt(line.substring(10)); }
else if (line.startsWith("placeXP03:")) { placeXP03 = Integer.parseInt(line.substring(10)); }
else if (line.startsWith("placeXP04:")) { placeXP04 = Integer.parseInt(line.substring(10)); }
else if (line.startsWith("placeXP05:")) { placeXP05 = Integer.parseInt(line.substring(10)); }
else if (line.startsWith("placeXP06:")) { placeXP06 = Integer.parseInt(line.substring(10)); }
else if (line.startsWith("placeXP07:")) { placeXP07 = Integer.parseInt(line.substring(10)); }
else if (line.startsWith("placeXP08:")) { placeXP08 = Integer.parseInt(line.substring(10)); }
else if (line.startsWith("placeXP09:")) { placeXP09 = Integer.parseInt(line.substring(10)); }
else if (line.startsWith("placeXP10:")) { placeXP10 = Integer.parseInt(line.substring(10)); }
else if (line.startsWith("placeXP11:")) { placeXP11 = Integer.parseInt(line.substring(10)); }
else if (line.startsWith("placeXP12:")) { placeXP12 = Integer.parseInt(line.substring(10)); }
else if (line.startsWith("placeXP13:")) { placeXP13 = Integer.parseInt(line.substring(10)); }
else if (line.startsWith("placeXP14:")) { placeXP14 = Integer.parseInt(line.substring(10)); }
else if (line.startsWith("placeXP15:")) { placeXP15 = Integer.parseInt(line.substring(10)); }
else if (line.startsWith("placeXP16:")) { placeXP16 = Integer.parseInt(line.substring(10)); }
else if (line.startsWith("placeXP17:")) { placeXP17 = Integer.parseInt(line.substring(10)); }
else if (line.startsWith("placeXP18:")) { placeXP18 = Integer.parseInt(line.substring(10)); }
else if (line.startsWith("placeXP19:")) { placeXP19 = Integer.parseInt(line.substring(10)); }
else if (line.startsWith("placeXP20:")) { placeXP20 = Integer.parseInt(line.substring(10)); }
else if (line.startsWith("placeXP21:")) { placeXP21 = Integer.parseInt(line.substring(10)); }
else if (line.startsWith("placeXP22:")) { placeXP22 = Integer.parseInt(line.substring(10)); }
else if (line.startsWith("placeXP23:")) { placeXP23 = Integer.parseInt(line.substring(10)); }
else if (line.startsWith("placeXP24:")) { placeXP24 = Integer.parseInt(line.substring(10)); }
else if (line.startsWith("placeXP25:")) { placeXP25 = Integer.parseInt(line.substring(10)); }
else if (line.startsWith("placeXP26:")) { placeXP26 = Integer.parseInt(line.substring(10)); }
else if (line.startsWith("placeXP27:")) { placeXP27 = Integer.parseInt(line.substring(10)); }
else if (line.startsWith("placeXP28:")) { placeXP28 = Integer.parseInt(line.substring(10)); }
else if (line.startsWith("placeXP29:")) { placeXP29 = Integer.parseInt(line.substring(10)); }
else if (line.startsWith("placeXP30:")) { placeXP30 = Integer.parseInt(line.substring(10)); }

else if (line.startsWith("placeN01:")) { placeN01 = Misc.longToString(Long.parseLong(line.substring(9))); }
else if (line.startsWith("placeN02:")) { placeN02 = Misc.longToString(Long.parseLong(line.substring(9))); }
else if (line.startsWith("placeN03:")) { placeN03 = Misc.longToString(Long.parseLong(line.substring(9))); }
else if (line.startsWith("placeN04:")) { placeN04 = Misc.longToString(Long.parseLong(line.substring(9))); }
else if (line.startsWith("placeN05:")) { placeN05 = Misc.longToString(Long.parseLong(line.substring(9))); }
else if (line.startsWith("placeN06:")) { placeN06 = Misc.longToString(Long.parseLong(line.substring(9))); }
else if (line.startsWith("placeN07:")) { placeN07 = Misc.longToString(Long.parseLong(line.substring(9))); }
else if (line.startsWith("placeN08:")) { placeN08 = Misc.longToString(Long.parseLong(line.substring(9))); }
else if (line.startsWith("placeN09:")) { placeN09 = Misc.longToString(Long.parseLong(line.substring(9))); }
else if (line.startsWith("placeN10:")) { placeN10 = Misc.longToString(Long.parseLong(line.substring(9))); }
else if (line.startsWith("placeN11:")) { placeN11 = Misc.longToString(Long.parseLong(line.substring(9))); }
else if (line.startsWith("placeN12:")) { placeN12 = Misc.longToString(Long.parseLong(line.substring(9))); }
else if (line.startsWith("placeN13:")) { placeN13 = Misc.longToString(Long.parseLong(line.substring(9))); }
else if (line.startsWith("placeN14:")) { placeN14 = Misc.longToString(Long.parseLong(line.substring(9))); }
else if (line.startsWith("placeN15:")) { placeN15 = Misc.longToString(Long.parseLong(line.substring(9))); }
else if (line.startsWith("placeN16:")) { placeN16 = Misc.longToString(Long.parseLong(line.substring(9))); }
else if (line.startsWith("placeN17:")) { placeN17 = Misc.longToString(Long.parseLong(line.substring(9))); }
else if (line.startsWith("placeN18:")) { placeN18 = Misc.longToString(Long.parseLong(line.substring(9))); }
else if (line.startsWith("placeN19:")) { placeN19 = Misc.longToString(Long.parseLong(line.substring(9))); }
else if (line.startsWith("placeN20:")) { placeN20 = Misc.longToString(Long.parseLong(line.substring(9))); }
else if (line.startsWith("placeN21:")) { placeN21 = Misc.longToString(Long.parseLong(line.substring(9))); }
else if (line.startsWith("placeN22:")) { placeN22 = Misc.longToString(Long.parseLong(line.substring(9))); }
else if (line.startsWith("placeN23:")) { placeN23 = Misc.longToString(Long.parseLong(line.substring(9))); }
else if (line.startsWith("placeN24:")) { placeN24 = Misc.longToString(Long.parseLong(line.substring(9))); }
else if (line.startsWith("placeN25:")) { placeN25 = Misc.longToString(Long.parseLong(line.substring(9))); }
else if (line.startsWith("placeN26:")) { placeN26 = Misc.longToString(Long.parseLong(line.substring(9))); }
else if (line.startsWith("placeN27:")) { placeN27 = Misc.longToString(Long.parseLong(line.substring(9))); }
else if (line.startsWith("placeN28:")) { placeN28 = Misc.longToString(Long.parseLong(line.substring(9))); }
else if (line.startsWith("placeN29:")) { placeN29 = Misc.longToString(Long.parseLong(line.substring(9))); }
else if (line.startsWith("placeN30:")) { placeN30 = Misc.longToString(Long.parseLong(line.substring(9))); }
